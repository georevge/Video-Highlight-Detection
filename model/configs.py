...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--video_type', type=str, default='TVSum', help='Dataset to be used')

    # Model
    parser.add_argument('--input_size', type=int, default=512, help='Feature size expected in the input')  #512
    ...
    parser.add_argument('--n_segments', type=int, default=None, help='Number of segments to split the video')
    parser.add_argument('--pos_enc', type=str, default=None, help="Type of pos encoding [absolute|relative|None]")
    parser.add_argument('--heads', type=int, default=1, help="Number of global heads for the attention module")
    ...
    parser.add_argument('--lr', type=float, default=1e-5, help='Learning rate used for the modules')
    ...
    parser.add_argument('--init_type', type=str, default=None, help='Weight initialization method')  # "xavier"
